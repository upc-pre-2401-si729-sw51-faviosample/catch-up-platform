...
## Summary
This project is a simple REST API that expands the experience of CatchUp application, the News API client app, with the possibility of saving favorite news sources. It is implemented with Java language, Spring Boot framework, Spring Data JPA ORM, and MySQL database driver. It also illustrates Domain-Driven Design approach with tactical patterns.
